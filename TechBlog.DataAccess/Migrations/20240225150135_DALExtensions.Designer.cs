...
namespace TechBlog.DataAccess.Migrations
{
    ...
    [Migration("20240225150135_DALExtensions")]
            ...
            modelBuilder.Entity("TechBlog.Entity.Entites.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7b1868a0-d8c3-49e2-ac16-26def8346713"),
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 2, 25, 19, 1, 34, 697, DateTimeKind.Local).AddTicks(2951),
                        ...
                        new
                        {
                            Id = new Guid("f4d660e2-ee69-4263-9c11-ea3220729128"),
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 2, 25, 19, 1, 34, 697, DateTimeKind.Local).AddTicks(2959),
            ...
            modelBuilder.Entity("TechBlog.Entity.Entites.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 2, 25, 19, 1, 34, 697, DateTimeKind.Local).AddTicks(4620),
                            IsDeleted = false,
                            Name = "ASP.NET Core"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 2, 25, 19, 1, 34, 697, DateTimeKind.Local).AddTicks(4625),
                            IsDeleted = false,
                            Name = "C#"
                        });
                });
            ...
            modelBuilder.Entity("TechBlog.Entity.Entites.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 2, 25, 19, 1, 34, 697, DateTimeKind.Local).AddTicks(5727),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 2, 25, 19, 1, 34, 697, DateTimeKind.Local).AddTicks(5734),
